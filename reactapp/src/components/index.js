...
export { default as NewProject } from './_ProjectPage/NewProject';
export { default as EditProject } from './_ProjectPage/EditProject';
export { default as Post } from './_ProjectPage/Post/Post';
...
export {
	default as SuggestedSearch
} from './SuggestedSearch/SuggestedSearchBar';
